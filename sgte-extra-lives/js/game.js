...
playState.preload = function () {
    ...
    game.load.spritesheet("lives", "https://cdn.glitch.com/df3d4bd4-a145-4f00-bfad-97b20729e2ee%2Fanimated%20heart.png?1552402820711",48,12); 
...
playState.create = function () {
    ...
    //add the image of hearts in the top left
    var livesSprite = game.add.sprite(20, 20, "lives");
  
    //find out how many lives are left and set the frame of the lives image appropriately  
    if (lives === 3){
