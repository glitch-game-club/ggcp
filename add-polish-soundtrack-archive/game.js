...
playState.preload = function () {
    ...
    //key lines follow - copy these to anywhere  your preload function
    game.load.audio('soundtrack' , 'https://cdn.glitch.com/04f51d70-ab26-4960-8e87-12f2aa251cff%2Fbackground_noise.wav');
};

playState.create = function () {

    //key lines follow - copy these to anywhere in your create function
    backgroundnoise = game.sound.add("soundtrack", 1, true);
