...
// List variables which can be easily changed by remixers to alter gameplay on separate lines
var gravity = 500;
var velocity_x = 200;
var velocity_y = 300;
var tween1Speed = 2000

// List other variables that are used by more than one function on one line
var player, platforms, coins, coinSound, hazards, hazardSound;

// Create an object for the main state of our game called playState
var playState = {};
...
playState.create = function () {
    ...
    var ground, platform1, platform2, platform3, hazard1, enemy1, tween1, coin, i;
    ...
    tween1.to({x: 350, y: 115}, tween1Speed, null, true, 0, -1, true);
};
